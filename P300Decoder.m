function P300Decoder(directory, Stimulus_1duration, Stimulus_2duration, header)
% ===
...
[AllTargetData_Filtered_P300_DS64Hz, AllNonTargetData_Filtered_P300_DS64Hz, Duration_points_256Hz_Downsampled] =...
    DownSampling(AllTargetData_Filtered_P300, AllNonTargetData_Filtered_P300, Electrodes, floor(Sampling_Hz_256 * Stimulus_2duration));
...
[EachElectrodeAveragedTarget2d_DS64Hz_4cls1, SEEachElectrodeTarget2d_DS64Hz_4cls1, EachElectrodeAveragedNonTarget2d_DS64Hz_4cls1, SEEachElectrodeNonTarget2d_DS64Hz_4cls1,...
    ...
    getERPfromCSV(AllTargetData_no1(:, 2:9), AllNonTargetData_no1(:, 2:9), floor(Sampling_Hz_64 * Stimulus_2duration));
[EachElectrodeAveragedTarget2d_DS64Hz_4cls2, SEEachElectrodeTarget2d_DS64Hz_4cls2, EachElectrodeAveragedNonTarget2d_DS64Hz_4cls2, SEEachElectrodeNonTarget2d_DS64Hz_4cls2,...
    ...
    getERPfromCSV(AllTargetData_no2(:, 2:9), AllNonTargetData_no2(:, 2:9), floor(Sampling_Hz_64 * Stimulus_2duration));
[EachElectrodeAveragedTarget2d_DS64Hz_4cls3, SEEachElectrodeTarget2d_DS64Hz_4cls3, EachElectrodeAveragedNonTarget2d_DS64Hz_4cls3, SEEachElectrodeNonTarget2d_DS64Hz_4cls3,...
    ...
    getERPfromCSV(AllTargetData_no3(:, 2:9), AllNonTargetData_no3(:, 2:9), floor(Sampling_Hz_64 * Stimulus_2duration));
[EachElectrodeAveragedTarget2d_DS64Hz_4cls4, SEEachElectrodeTarget2d_DS64Hz_4cls4, EachElectrodeAveragedNonTarget2d_DS64Hz_4cls4, SEEachElectrodeNonTarget2d_DS64Hz_4cls4,...
    ...
    getERPfromCSV(AllTargetData_no4(:, 2:9), AllNonTargetData_no4(:, 2:9), floor(Sampling_Hz_64 * Stimulus_2duration));
...
drawSignalGraph(MeanAllElectrodeTarget1d_DS64Hz_8ch, SEAllTarget1d_DS64Hz_8ch, MeanAllElectrodeNonTarget1d_DS64Hz_8ch,...
    SEAllNonTarget1d_DS64Hz_8ch, 1, 'SBE-AllElectrodesMeanAverage(1-8Ch, Downsampled)', Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
...
drawSignalGraph(MeanAllElectrodeTarget1d_DS64Hz_4cls1, SEAllTarget1d_DS64Hz_4cls1, MeanAllElectrodeNonTarget1d_DS64Hz_4cls1,...
    SEAllNonTarget1d_DS64Hz_4cls1, 1, '4cls 1Leftarm Ave(1-8Ch, DSed)', Stimulus_2duration, floor(Sampling_Hz_64 * Stimulus_2duration), 0.0);
subplot(3, 4, 10)
drawSignalGraph(MeanAllElectrodeTarget1d_DS64Hz_4cls2, SEAllTarget1d_DS64Hz_4cls2, MeanAllElectrodeNonTarget1d_DS64Hz_4cls2,...
    SEAllNonTarget1d_DS64Hz_4cls2, 1, '4cls 2Rightarm Ave(1-8Ch, DSed)', Stimulus_2duration, floor(Sampling_Hz_64 * Stimulus_2duration), 0.0);
subplot(3, 4, 11)
drawSignalGraph(MeanAllElectrodeTarget1d_DS64Hz_4cls3, SEAllTarget1d_DS64Hz_4cls3, MeanAllElectrodeNonTarget1d_DS64Hz_4cls3,...
    SEAllNonTarget1d_DS64Hz_4cls3, 1, '4cls 3Leftleg Ave(1-8Ch, DSed)', Stimulus_2duration, floor(Sampling_Hz_64 * Stimulus_2duration), 0.0);
subplot(3, 4, 12)
drawSignalGraph(MeanAllElectrodeTarget1d_DS64Hz_4cls4, SEAllTarget1d_DS64Hz_4cls4, MeanAllElectrodeNonTarget1d_DS64Hz_4cls4,...
    SEAllNonTarget1d_DS64Hz_4cls4, 1, '4cls 4Rightleg Ave(1-8Ch, DSed)', Stimulus_2duration, floor(Sampling_Hz_64 * Stimulus_2duration), 0.0);
...
figure
subplot(2, 4, 1)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 1, Electrodes(1,1), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 2)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 2, Electrodes(1,2), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 3)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 3, Electrodes(1,3), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 4)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 4, Electrodes(1,4), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 5)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 5, Electrodes(1,5), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 6)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 6, Electrodes(1,6), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 7)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 7, Electrodes(1,7), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
subplot(2, 4, 8)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch, SEEachElectrodeNonTarget2d_DS64Hz_8ch, 8, Electrodes(1,8), Stimulus_2duration, Duration_points_256Hz_Downsampled, 0.0);
