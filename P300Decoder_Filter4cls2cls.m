function P300Decoder_Filter4cls2cls(directory, Stimulus_1duration, Stimulus_2duration, header, Ymax, Ymin, savePNG)
%
% :-:-:-:-:-:-:-:-:-: Up to date INFO :-:-:-:-:-:-:-:-:
%
% (2/24 17:08) Caution! Now version is only for the file 6 for now (Filterling setting or so)
%
% :::::::::::::::::::: Instruction ::::::::::::::::::::
%
...
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 1, Electrodes_8(1,1), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 2)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 2, Electrodes_8(1,2), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 3)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 3, Electrodes_8(1,3), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 4)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 4, Electrodes_8(1,4), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 5)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 5, Electrodes_8(1,5), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 6)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 6, Electrodes_8(1,6), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 7)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 7, Electrodes_8(1,7), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
subplot(2, 4, 8)
drawSignalGraph(EachElectrodeAveragedTarget2d_DS64Hz_8ch, SEEachElectrodeTarget2d_DS64Hz_8ch, EachElectrodeAveragedNonTarget2d_DS64Hz_8ch,...
    SEEachElectrodeNonTarget2d_DS64Hz_8ch, 8, Electrodes_8(1,8), Stimulus_2duration, Duration_points_256Hz_Downsampled, gap, Ymax, Ymin);
